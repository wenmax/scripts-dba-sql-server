SELECT  SERVERPROPERTY('Servername') AS 'Servidor',  
              ...
              msdb.dbo.backupset.backup_start_date As 'Data Execução',   
              msdb.dbo.backupset.backup_finish_date As 'Data Encerramento', 
              msdb.dbo.backupset.expiration_date As 'Data de Expiração',          
              ...
              msdb.dbo.backupset.description As 'Descrição', 
