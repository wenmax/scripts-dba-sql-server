...
BEGIN
	...
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Traces].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Trace Queries Demoradas')
	...
	-- Trava de segurança para colocar um valor default na variavel
	...
	*******************************************************************************************************************************/
	exec @rc = sp_trace_create @TraceID output, 0, N'C:\Temp\Duracao', @maxfilesize, NULL 
